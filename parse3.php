...
while ($line = fgets($fh)) {
    ...
    $tarif_tol = strstr($line, 'JM0'). ","; # JM001 15000.00 15000.00 04/PALIMANAN 24/CIKARANG UTAMA 23 1 1 451758 088833 019941 31/12/2018 23:05:24 31/12/2018 23:05:24 000885023100201 20181231EPJ01143001141112.share
    ...
    $tarif_tol_4 = str_replace(",", " ", $tarif_tol_3);
    $tarif_tol_5 = strstr($tarif_tol_4, " ", true);
    /*echo "<pre>";
    print_r($tarif_tol_5);
    echo "</pre>";*/
    echo $tarif_tol_5. "</br>";
